    ...
    <div class="flex-1 px-20">
        ...
        <div class="flex flex-col">
            <span class="flex items-center gap-x-8">
                ...
                <svg class="fill-dss-purple" height="48" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p class="text-3xl text-dss-purple font-semibold">Form Penilaian</p>
            </span>
            ...
            <span class="flex justify-end gap-x-4 mb-8">
                ...
                <button class="bg-dss-purple hover:bg-dss-purple-hover text-white text-md font-medium py-2 px-6 rounded-xl" data-bs-toggle="modal" data-bs-target="#tambahFormPenilaian">
                    <span class="flex items-center gap-x-2">
            ...
            <livewire:table-form-penilaian/>

            {{-- Add dialog --}}
            <livewire:modal-tambah-form-penilaian/>
        </div>
    </div>
</div>
