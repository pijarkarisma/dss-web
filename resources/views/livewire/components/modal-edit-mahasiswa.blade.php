<div wire:ignore class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
  id="editMahasiswaModal-{{$nim}}" tabindex="-1" aria-labelledby="editMahasiswaModalLabel-{{$nim}}" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg relative w-auto pointer-events-none">
    <div
      ...
      <div
        ...
        <h5 class="text-2xl font-medium leading-normal text-gray-800" id="editMahasiswaModalLabel-{{$nim}}">
          Edit Mahasiswa
        </h5>
        <button type="button"
      ...
      <form id="formEditMhs-{{$nim}}" wire:submit.prevent="update">
        ...
        <div
            ...
            <button type="submit" form="formEditMhs-{{$nim}}"
